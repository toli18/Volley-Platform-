...
- `POST /api/pending/exercises/<id>/approve` — премества упражнението в основния списък със статус approved
- `POST /api/pending/exercises/<id>/reject` — премахва упражнението от чакащите
